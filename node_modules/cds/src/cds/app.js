...
/*
 * NOTE:
 * Warning it inits all the angular module, which might be NOT what you want
 * it is suggested though to use the ``module.js`` from each module to init
 * them individually.
 */

(function (angular) {
  // Setup the whole cdsAPP
